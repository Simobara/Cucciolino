          ...
          <div className="bg-[#cfe0f2] relative">
            <div className="mx-auto max-w-[880px] px-5 sm:px-10 pt-20 sm:pt-24 pb-10 sm:pb-12 max-md:pt-16 max-md:pb-8">
              ...
              <div className="md:mt-20 mt-10 sm:mt-16 pb-8 sm:pb-10 max-md:mt-12">
                <div
                  className="flex items-end justify-center gap-6 sm:gap-10 md:ml-44 ml-2 mt-8 mb-30
                  max-md:ml-2 max-md:justify-start max-md:gap-4"
                >
                  <div
                  ...
                  <div
                    className="relative w-[110px] h-[110px] ml-8 mt-8
                    sm:w-[140px] sm:h-[140px]
                    scale-230 max-md:scale-[1.8] max-md:ml-4 max-md:mt-4 opacity-90"
                  >
                    <Image
...
function GelatoItem(props: GelatoItemProps) {
  ...
  return (
    <div className="md:py-2 py-5 max-md:py-4">
      <div
        className="font-sofiapro font-bold uppercase text-[#ef4136]
